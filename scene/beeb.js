define('scene/beeb', ['three', '../utils', 'three-gltf-loader'], function(THREE, utils) {
    "use strict";
    ...
    class Beeb {
        ...
        makeScreenMaterial(maskTexture, screenPrologFragment, screenEmissiveFragment, screenEpilogFragment) {
            ...
            screenMaterial.onBeforeCompile = shader => {
                ...
                shader.uniforms.maskIntensity = {
                    value: 1
                };
                shader.uniforms.screenColR = {
                    type: 'vec3',
                    value: new THREE.Vector3(1, 0, 0)
                };
                shader.uniforms.screenColG = {
                    type: 'vec3',
                    value: new THREE.Vector3(0, 1, 0)
                };
                shader.uniforms.screenColB = {
                    type: 'vec3',
