define('6502.opcodes', ['./utils'], function(utils) {
    "use strict";
    ...
    function getOp(op, arg) {
        switch (op) {
            ...
            case "LDA":
                return {
                    op: ["cpu.a = cpu.setzn(REG);"],
                    read: true
                };
            case "LDX":
                return {
                    op: ["cpu.x = cpu.setzn(REG);"],
                    read: true
                };
            case "LDY":
                return {
                    op: ["cpu.y = cpu.setzn(REG);"],
                    read: true
                };
            case "STA":
                return {
            ...
            case "INX":
                return {
                    op: ["cpu.x = cpu.setzn(cpu.x + 1);"]
                };
            case "INY":
                return {
                    op: ["cpu.y = cpu.setzn(cpu.y + 1);"]
                };
            case "DEX":
                return {
                    op: ["cpu.x = cpu.setzn(cpu.x - 1);"]
            ...
            case "TXA":
                return {
                    op: ["cpu.a = cpu.setzn(cpu.x);"]
                };
            case "TAX":
                return {
                    op: ["cpu.x = cpu.setzn(cpu.a);"]
                };
            case "TXS":
                return {
                    op: "cpu.s = cpu.x;"
            ...
            case "TSX":
                return {
                    op: ["cpu.x = cpu.setzn(cpu.s);"]
                };
            case "TYA":
                return {
                    op: ["cpu.a = cpu.setzn(cpu.y);"]
                };
            case "TAY":
                return {
                    op: ["cpu.y = cpu.setzn(cpu.a);"]
                };
            case "BEQ":
                return {
                    op: "cpu.branch(cpu.p.z);"
                };
            case "BNE":
                return {
                    op: "cpu.branch(!cpu.p.z);"
            ...
            case "SHX":
                return {
                    op: "REG = (cpu.x & ((addr >>> 8)+1)) & 0xff;",
                    write: true
                };
            case "SHY":
                return {
                    op: "REG = (cpu.y & ((addr >>> 8)+1)) & 0xff;",
                    write: true
                };
